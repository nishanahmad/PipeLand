...
if(isset($_SESSION["user_name"]))
{
	...
	$salesList = mysqli_query($con, "SELECT ar_id,SUM(qty),SUM(return_bag) FROM nas_sale WHERE deleted IS NULL AND YEAR(entry_date) = $year AND MONTH(entry_date) = $month AND ar_id IN ('$array') GROUP BY ar_id" ) or die(mysqli_error($con));
