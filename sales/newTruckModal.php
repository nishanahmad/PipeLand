...
{																																															?>	
	...
	<div class="modal fade" id="newTruckModal" style="margin-top:100px;">
	  <div class="modal-dialog modal-xs">
		<div class="modal-content">
			...
			<div class="modal-body">
				<br/>
				<p id="truckInsertError" style="color:red;"></p>
				...
				<div class="col col-md-8 offset-1">
					<div class="input-group mb-3">
						...
						<input type="text" name="phone" id="driverphone" class="form-control" autocomplete="off">
					</div>
				</div>
				<br/><br/>
				<div class="row">
					<div class="col col-md-5 offset-5">
						<div class="input-group mb-3">
							<button class="btn" id="saveNewTruck" style="width:100px;font-size:18px;background-color:#54698D;color:white;"><i class="fa fa-save"></i> Save</button>				 
						</div>
					</div>							
				</div>																			
			</div>
